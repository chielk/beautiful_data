...
\begin{frame}
	...
	\end{center}
% previously other techniques could be used
% these were not as fast or as good
% goals:
%	* visualize possible outcome of craniofacial surgery
%	* screening for colon cancer
\end{frame}

\begin{frame}
	\frametitle{2001: 4D} % tory et al
	...
	\end{center}
% can study something over time
% this can be combined with other techniques such as
% scatter plots
% iso surfaces
% this was done in animation form
\end{frame}
